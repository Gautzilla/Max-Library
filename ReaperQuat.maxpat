...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1725.0, 750.0, 154.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1725.0, 720.0, 286.0, 23.0 ],
					"text" : "t/action/_0a651235823b6a4eb6cf849176b974be"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1725.0, 690.0, 180.0, 23.0 ],
					"restore" : [ 0.0 ],
...
,
					"text" : "pattr _ mira_btn_clearTake",
					"varname" : "_[7]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.096160858869553, 91.82692614197731, 90.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 195.0, 94.5, 60.0, 21.0 ],
					"text" : "Folder",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 92.0, 90.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 30.0, 94.5, 120.425525993108749, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1725.0, 105.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 93.0, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1725.0, 135.0, 35.0, 23.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1695.0, 300.0, 68.0, 23.0 ],
					"text" : "FileCheck"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1875.0, 180.0, 68.0, 23.0 ],
					"text" : "t 1 clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1695.0, 240.0, 114.0, 23.0 ],
					"text" : "r #0folderName"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1695.0, 269.0, 272.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1725.0, 195.0, 55.0, 23.0 ],
					"text" : "pv take"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1695.0, 330.0, 94.0, 23.0 ],
					"text" : "prepend write"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 0.0, 120.0, 285.0, 45.106380760669708 ],
					"rounded" : 0.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1770.0, 105.0, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1725.0, 165.0, 94.0, 23.0 ],
					"text" : "t b zlclear b"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 75.0, 285.096163362264633, 90.000002503395081 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 150.0, 285.106368958950043, 29.893616288900375 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 765.0, 555.0, 1170.0, 375.0 ],
					"presentation" : 1,
