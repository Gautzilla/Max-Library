...
,
		"classnamespace" : "box",
		"rect" : [ 1955.0, -278.0, 1980.0, 1011.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 105.0, 345.0, 35.0, 23.0 ],
					"text" : "== 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 75.0, 315.0, 41.0, 23.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 105.0, 285.0, 35.0, 23.0 ],
					"text" : "== 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 75.0, 255.0, 41.0, 23.0 ],
					"text" : "t i i"
				}
