...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 300.0, 60.0, 94.0, 23.0 ],
					"text" : "patcherargs s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 165.0, 35.0, 23.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 165.0, 94.0, 23.0 ],
					"text" : "prepend write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 30.0, 105.0, 61.0, 23.0 ],
					"text" : "sel bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 135.0, 81.0, 23.0 ],
					"text" : "pv filePath"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 105.0, 81.0, 23.0 ],
					"text" : "pv filePath"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Bang writes on file, Toggle toggles auto write on edit",
					"comment" : "Bang writes on file, Toggle toggles auto write on edit",
					"hint" : "Bang writes on file, Toggle toggles auto write on edit",
					"id" : "obj-8",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 30.0, 210.0, 40.0, 23.0 ],
					"text" : "text"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 330.0, 35.0 ],
					"suppressinlet" : 1,
					"text" : "Permet l'écriture automatique d'un texte dans un fichier"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 390.0, 225.0 ],
					"proportion" : 0.5,
