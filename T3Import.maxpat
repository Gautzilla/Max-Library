...
,
		"classnamespace" : "box",
		"rect" : [ 1954.0, -272.0, 1612.0, 1013.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 225.0, 150.0, 41.0, 23.0 ],
					"text" : "t 1 b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 225.0, 120.0, 41.0, 23.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 225.0, 45.0, 101.0, 23.0 ],
					"text" : "patcherargs 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 405.0, 150.0, 101.0, 23.0 ],
					"text" : "routepass port"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 345.0, 60.0, 68.0, 23.0 ],
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 89.999992370605469, 41.0, 23.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "list", "" ],
					"patching_rect" : [ 345.0, 360.0, 147.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 330.0, 50.5, 23.0 ],
					"text" : "join 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.0, 285.0, 101.0, 23.0 ],
					"text" : "T3ToQuaternion"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 285.0, 101.0, 23.0 ],
					"text" : "T3ToQuaternion"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 285.0, 101.0, 23.0 ],
					"text" : "T3ToQuaternion"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 285.0, 101.0, 23.0 ],
					"text" : "T3ToQuaternion"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 345.0, 240.0, 103.0, 23.0 ],
					"text" : "unjoin 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 345.0, 210.0, 68.0, 23.0 ],
					"text" : "route 113"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 180.0, 107.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 225.0, 210.0, 42.0, 23.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 225.0, 180.0, 62.0, 23.0 ],
					"text" : "metro 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 89.999992370605469, 35.0, 23.0 ],
					"text" : "9600"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 89.999992370605469, 55.0, 23.0 ],
					"text" : "chunk 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.0, 89.999992370605469, 41.0, 23.0 ],
					"text" : "dtr 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 345.0, 30.0, 61.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 345.0, 150.0, 49.0, 23.0 ],
					"text" : "serial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 15.0, 570.0, 420.0 ],
					"proportion" : 0.5,
...
, 			{
				"box" : 				{
					...
					"suppressinlet" : 1,
					"text" : "Importe les données du T3 (quaternions)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 119.999992370605469, 150.0, 23.0 ]
				}
