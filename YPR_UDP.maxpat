...
,
		"classnamespace" : "box",
		"rect" : [ 2723.0, -114.0, 1079.0, 1011.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 345.0, 420.0, 68.0, 23.0 ],
					"text" : "sel Y P R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 390.0, 74.0, 23.0 ],
					"text" : "r #0Ping"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 510.0, 465.0, 74.0, 23.0 ],
					"text" : "s #0Ping"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 465.0, 68.0, 23.0 ],
					"text" : "s #0UDP"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 135.0, 345.0, 41.0, 23.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "R" ],
					"patching_rect" : [ 600.0, 435.0, 28.0, 23.0 ],
					"text" : "t R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "P" ],
					"patching_rect" : [ 555.0, 435.0, 28.0, 23.0 ],
					"text" : "t P"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "Y" ],
					"patching_rect" : [ 510.0, 435.0, 28.0, 23.0 ],
					"text" : "t Y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 600.0, 405.0, 30.0, 16.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 405.0, 30.0, 16.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 510.0, 405.0, 30.0, 16.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 600.0, 375.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlinecolor" : [ 0.294117647058824, 0.447058823529412, 0.431372549019608, 1.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 555.0, 375.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 585.0, 330.000015258789062, 53.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 135.0, 315.0, 114.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 405.0, 107.0, 23.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 435.0, 127.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "list", "" ],
					"patching_rect" : [ 135.0, 375.0, 101.0, 23.0 ],
					"text" : "jit.quat2euler"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 315.0, 75.0, 21.0 ],
					"suppressinlet" : 1,
					"text" : "PINGS"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 315.0, 195.0, 180.0 ],
					"proportion" : 0.5,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 435.0, 480.0 ],
					"proportion" : 0.5,
					"prototypename" : "backgroundPanel"
				}
