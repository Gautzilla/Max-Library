...
,
		"classnamespace" : "box",
		"rect" : [ 1954.0, -278.0, 1624.0, 1004.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 345.0, 41.0, 23.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 135.0, 75.0, 21.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 105.0, 30.0, 60.0, 35.0 ],
					"text" : "UDP port",
					"textcolor" : [ 0.780392169952393, 0.482352942228317, 0.345098048448563, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 195.0, 75.0, 35.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 165.0, 75.0, 21.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 0.0, 30.000001907348633, 45.0, 35.0 ],
					"text" : "YPR send",
					"textcolor" : [ 0.780392169952393, 0.482352942228317, 0.345098048448563, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 165.0, 88.0, 23.0 ],
					"text" : "prepend port"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 225.0, 90.0, 114.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 135.0, 50.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 110.0, 5.000001907348633, 50.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 60.0, 195.0, 41.0, 23.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 63.0, 4.000001907348633, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 60.0, 315.0, 114.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 60.0, 405.0, 107.0, 23.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 435.0, 160.0, 23.0 ],
					"text" : "ReaperYawPitchRoll 8000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "list", "" ],
					"patching_rect" : [ 60.0, 375.0, 101.0, 23.0 ],
					"text" : "jit.quat2euler"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.5, 4.000001907348633, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 60.0, 285.0, 61.0, 23.0 ],
					"text" : "T3Import"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 435.0, 465.0 ],
					"proportion" : 0.5,
					"prototypename" : "backgroundPanel"
				}
