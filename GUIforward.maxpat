...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 240.0, 88.0, 23.0 ],
					"text" : "prepend send"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.0, 270.0, 101.0, 23.0 ],
					"text" : "prepend bindto"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 210.0, 101.0, 23.0 ],
					"text" : "prepend bindto"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 660.0, 225.0, 286.0, 23.0 ],
					"text" : "combine parent:: scriptingName @triggers 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 435.0, 180.0, 286.0, 23.0 ],
					"text" : "combine parent:: scriptingName @triggers 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 315.0, 135.0, 74.0, 23.0 ],
					"text" : "unpack s s"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Scripting name of the target GUI object",
					"comment" : "Scripting name of the target GUI object",
					"hint" : "Scripting name of the target GUI object",
					"id" : "obj-4",
					"index" : 2,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"annotation" : "Scripting name of the source GUI object",
					"comment" : "Scripting name of the source GUI object",
					"hint" : "Scripting name of the source GUI object",
					"id" : "obj-3",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 105.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 345.0, 88.0, 23.0 ],
					"text" : "pattrforward",
					"varname" : "u413009963[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 315.0, 81.0, 23.0 ],
					"text" : "prepend set",
					"varname" : "u413009963[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 225.0, 285.0, 41.0, 23.0 ],
					"restore" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 225.0, 255.0, 41.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 315.0, 105.0, 173.0, 23.0 ],
					"text" : "patcherargs source target"
				}
