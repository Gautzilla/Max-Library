...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"annotation" : "OSC messages to send to Reaper",
					"comment" : "OSC messages to send to Reaper",
					"hint" : "OSC messages to send to Reaper",
					"id" : "obj-1",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 167.0, 219.0, 61.0, 23.0 ],
					"text" : "f/yaw $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 347.0, 174.0, 48.0, 23.0 ],
					"text" : "/ 360."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 347.0, 144.0, 48.0, 23.0 ],
					"text" : "+ 180."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 257.0, 174.0, 48.0, 23.0 ],
					"text" : "/ 360."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 257.0, 144.0, 48.0, 23.0 ],
					"text" : "+ 180."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 167.0, 174.0, 48.0, 23.0 ],
					"text" : "/ 360."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 167.0, 144.0, 48.0, 23.0 ],
					"text" : "+ 180."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 405.0, 21.0 ],
					"suppressinlet" : 1,
					"text" : "Sends yaw pitch and roll to reaper as an OSC device message"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 420.0, 315.0 ],
					"proportion" : 0.5,
