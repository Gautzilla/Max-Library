...
,
		"classnamespace" : "box",
		"rect" : [ 1943.0, -259.0, 1612.0, 1013.0 ],
		"bglocked" : 0,
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"description" : "Convertit les données du T3 en Quaternions",
		"digest" : "Cf Olivier",
		"tags" : "",
		"style" : "",
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 15.0, 90.0, 21.0 ],
					"text" : "Cf Olivier"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 165.0, 89.0, 23.0 ],
					"text" : "round 0.0001"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 135.0, 213.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 135.0, 128.0, 23.0 ],
					"text" : "expr $f1 / (1<<14)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 90.0, 332.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 195.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 15.0, 375.0, 225.0 ],
					"proportion" : 0.5,
...
, 			{
				"box" : 				{
					...
					"suppressinlet" : 1,
					"text" : "Convertit les données du T3 en Quaternions"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 181.0, 207.0 ],
					"proportion" : 0.5,
					"prototypename" : "backgroundPanel"
				}
