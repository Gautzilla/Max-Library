...
,
		"classnamespace" : "box",
		"rect" : [ 1954.0, -275.0, 1613.0, 1004.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 75.0, 41.0, 23.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.0, 150.0, 94.0, 23.0 ],
					"text" : "pv maxDefault"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.0, 105.0, 94.0, 23.0 ],
					"text" : "pv minDefault"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 405.0, 60.0, 88.0, 23.0 ],
					"text" : "unpack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 405.0, 30.0, 121.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.0, 165.0, 50.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.0, 195.0, 50.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 240.0, 75.0, 41.0, 23.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 240.0, 134.999984741210938, 68.0, 23.0 ],
					"text" : "Trough 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "int", "int" ],
					"patching_rect" : [ 240.0, 105.0, 55.0, 23.0 ],
					"text" : "peak 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 15.0, 330.0, 270.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"suppressinlet" : 1,
					"text" : "Affiche les valeurs min et max reçues"
				}
