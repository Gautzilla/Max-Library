...
,
		"classnamespace" : "box",
		"rect" : [ 1954.0, -269.0, 1615.0, 1006.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 150.0, 90.0, 28.0, 23.0 ],
					"text" : "t i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 195.0, 45.0, 101.0, 23.0 ],
					"text" : "patcherargs 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 270.0, 48.0, 23.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 90.0, 315.0, 55.0, 23.0 ],
					"text" : "minimum"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 374.999969482421875, 35.0, 23.0 ],
					"text" : "mean"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 345.0, 81.0, 23.0 ],
					"text" : "zl.group 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 150.0, 94.0, 23.0 ],
					"text" : "sprintf %i %f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 30.0, 120.0, 88.0, 23.0 ],
					"text" : "counter 1 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 30.0, 225.0, 81.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 285.0, 435.0 ],
					"proportion" : 0.5,
