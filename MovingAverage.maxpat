...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 345.0, 75.0, 28.0, 23.0 ],
					"text" : "t i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 390.0, 30.0, 101.0, 23.0 ],
					"text" : "patcherargs 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 225.0, 165.0, 134.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 225.0, 255.0, 48.0, 23.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 285.0, 300.0, 55.0, 23.0 ],
					"text" : "minimum"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 225.0, 359.999969482421875, 35.0, 23.0 ],
					"text" : "mean"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 225.0, 330.0, 81.0, 23.0 ],
					"text" : "zl.group 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 135.0, 94.0, 23.0 ],
					"text" : "sprintf %i %f"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 225.0, 75.0, 41.0, 23.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 225.0, 105.0, 88.0, 23.0 ],
					"text" : "counter 1 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 225.0, 210.0, 81.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 15.0, 285.0, 420.0 ],
					"proportion" : 0.5,
