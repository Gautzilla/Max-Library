...
, 			{
				"box" : 				{
					"annotation" : "Input quaternion",
					"comment" : "Input quaternion",
					"hint" : "Input quaternion",
					"id" : "obj-2",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "list", "" ],
					"patching_rect" : [ 30.0, 135.0, 61.0, 23.0 ],
					"text" : "jit.quat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 195.0, 35.0 ],
					"suppressinlet" : 1,
					"text" : "Outputs the inverse of the input quaternion",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 195.0, 225.0 ],
					"proportion" : 0.5,
